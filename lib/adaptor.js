...
var Adaptor = module.exports = function Adaptor(opts) {
  ...
  this.events = [
    /**
     * Emitted when the C.H.I.P. has new analogRead data
     *
     * @event analogRead
    ...
    /**
     * Emitted when the C.H.I.P. has new digitalRead data
     *
     * @event digitalRead
     * @value val the value from the pin
     */
    ...
    /**
     * Emitted when the C.H.I.P. has written a value to a digital pin
     *
     * @event digitalWrite
     */
    "digitalWrite"
...
/**
 * Returns the C.H.I.P's firmware name
 *
